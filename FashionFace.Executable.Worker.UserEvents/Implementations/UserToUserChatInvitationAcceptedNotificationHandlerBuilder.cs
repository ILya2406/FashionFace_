...
public sealed class UserToUserChatInvitationAcceptedNotificationHandlerBuilder :
    IUserToUserChatInvitationAcceptedNotificationHandlerBuilder
{
    ...
    public AsyncEventHandler<BasicDeliverEventArgs> Build(
        ...
        ) =>
        {
            ...
            var logger =
                serviceProvider
                    .GetRequiredService<ILogger<UserToUserChatInvitationAcceptedNotificationHandlerBuilder>>();
            ...
            var eventMessage =
                serializationDecorator
                    .Deserialize<HandleUserToUserInvitationAcceptedOutbox>(
                        messageAsString
                    );
