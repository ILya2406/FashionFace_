...
public sealed class UserToUserChatMessageSendHandlerBuilder : IUserToUserChatMessageSendHandlerBuilder
{
    public AsyncEventHandler<BasicDeliverEventArgs> Build(
        ...
        ) =>
        {
            ...
            var logger =
                serviceProvider.GetRequiredService<ILogger<UserToUserChatMessageSendHandlerBuilder>>();
            ...
            var eventMessage =
                serializationDecorator
                    .Deserialize<HandleUserToUserMessageSendOutbox>(
                        messageAsString
                    );
