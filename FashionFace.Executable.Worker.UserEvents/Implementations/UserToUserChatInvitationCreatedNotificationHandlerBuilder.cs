...
public sealed class UserToUserChatInvitationCreatedNotificationHandlerBuilder :
    IUserToUserChatInvitationCreatedNotificationHandlerBuilder
{
    ...
    public AsyncEventHandler<BasicDeliverEventArgs> Build(
        ...
        ) =>
        {
            ...
            var logger =
                serviceProvider
                    .GetRequiredService<ILogger<UserToUserChatInvitationCreatedNotificationHandlerBuilder>>();
            ...
            var eventMessage =
                serializationDecorator
                    .Deserialize<HandleUserToUserInvitationCreatedOutbox>(
                        messageAsString
                    );
